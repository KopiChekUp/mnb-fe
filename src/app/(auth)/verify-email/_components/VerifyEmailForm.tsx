...
export default function VerifyEmailForm() {
  ...
  if (!email) {
    return (
      <div className="w-full flex flex-col items-center justify-center px-10 sm:px-20">
        ...
        <Link href={ROUTES.SIGNUP} className="text-black font-bold hover:underline">
          Kembali ke Sign Up
        </Link>
      </div>
    );
  ...
  return (
    <div className="w-full lg:w-1/2 flex flex-col justify-center px-10 sm:px-20 lg:px-24 xl:px-32 relative z-10">
      ...
      <h1 className="text-4xl font-serif text-gray-900 leading-tight mb-4">Verifikasi Email</h1>
      <p className="text-sm text-gray-500 mb-2">Kami telah mengirim kode verifikasi 6 digit ke:</p>
      ...
      <form onSubmit={handleVerify} className="space-y-5">
        ...
        <div>
          <label htmlFor="code" className="block text-sm font-bold text-gray-800 mb-2">
            Kode Verifikasi
          </label>
          <input
            id="code"

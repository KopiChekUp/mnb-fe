      ...
      <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="absolute top-1/2 left-8 right-8 -translate-y-1/2 bg-white/20 backdrop-blur-md border border-white/40 p-10 rounded-2xl text-white shadow-lg">
          ...
          <p className="text-sm leading-relaxed opacity-90 font-medium">
            Match And Build redefines modern living. Discover our bold vision of contemporary
            architecture, cutting-edge interior design trends, and innovative lifestyle solutions.
          </p>
        </div>
      </div>
    </div>
